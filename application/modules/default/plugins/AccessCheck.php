...
class Plugin_AccessCheck extends Zend_Controller_Plugin_Abstract {
     ...
     * 
     * Zend_Controller_Request_Abstract $request(parament variable) from Acl library,
    ...
    //  $view = $layout->getView();
     // $_form = new Form_LoginForm();
      ...
      // $view->whatever = $_form;
        ...
        * This is from ACL library, the ControllerName (ressources),Module and Action
        * That the User(admins,users,guests) is asking to access
        * get the name of the controller and give to the ressources in der libraryAcl to compare,
        * together with action and role.
        */
